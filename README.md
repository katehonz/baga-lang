...
| **jwtbaga** | JWT HS256 / RS256 / ES256 · [repo](https://github.com/bagalang/jwtbaga) (submodule) |
...
| **metbaga** / **[logbaga](https://github.com/bagalang/logbaga)** / **[cloudbaga](https://github.com/bagalang/cloudbaga)** | Prometheus metrics, JSON logs, 12-factor demo (Track C1–C4) |
...
| **mdbaga**, **tplbaga**, **queuebaga**, **[jsonrpcbaga](https://github.com/bagalang/jsonrpcbaga)**, **[grebaga](https://github.com/bagalang/grebaga)**, **testbaga** | Markdown, templates, jobs, RPC, grep CLI, asserts |
