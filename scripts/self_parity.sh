...
if [ $FAIL -eq 0 ]; then
	echo "OK: self-hosting паритет — 52 PARITY, без поведенческа дивергенция (LP7+LP8)"
else
	exit 1
fi
